...
ggsave(filename="Count.png", plot=dodge_number_no_values,
       path=paste0(plot_path,"04_NMI/02_Comparisons/Overall/"))
ggsave(filename="Count_values.png", plot=dodge_number,
       path=paste0(plot_path,"00_Appendix/04_NMI/02_Comparisons/Overall/"))
...
#Save to plot_path
ggsave(filename="Percent.png", plot=stacked_percent, path=paste0(plot_path,"04_NMI/02_Comparisons/Overall/"))