...
#Save to plot_path
ggsave(filename="Comparision_euk_in_out_degrees_count.png", plot=stacked_number, path=paste(plot_path,"/Count/",sep=""))
...
#Save to plot_path
ggsave(filename="Comparision_euk_in_out_degrees_percent.png", plot=stacked_percent, path=paste(plot_path,"/Percent/",sep=""))
