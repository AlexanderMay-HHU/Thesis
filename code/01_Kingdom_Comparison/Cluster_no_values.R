...
#Save to plot_path
ggsave(filename="Cluster_Count.png", plot=gg_distribution_count, path=paste0(plot_path, "00_Appendix/01_Kingdom_Comparison/No_Values"))
...
#Save to plot_path
ggsave(filename="Cluster_Percent.png", plot=gg_distribution_percent, path=paste0(plot_path, "00_Appendix/01_Kingdom_Comparison/No_Values"))
...
#Save to plot_path
ggsave(filename="Cluster_ASV_Count.png", plot=gg_asv_cluster, path=paste0(plot_path, "01_Kingdom_Comparison"))